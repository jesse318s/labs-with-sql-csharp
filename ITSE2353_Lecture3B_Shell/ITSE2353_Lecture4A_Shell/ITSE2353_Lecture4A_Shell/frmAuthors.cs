...
namespace ITSE2353_Lecture4A_Shell
{
    public partial class frmAuthors : Form
    {
        ...
        {
            //point to help file
            hlpSample.HelpNamespace = Application.StartupPath + "\\Sample.chm";
            ...
            authorsManager = (CurrencyManager)this.BindingContext[ProgOps.DTAuthorsTable];
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           if(!ValidateData())
            ...
            {
                MessageBox.Show(ex.Message + " Error saving record.  Error 104", "Authors Table", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message + " Error deleting record. Error 103.", "Authors Table", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message + " Error adding record.  Error 102", "Authors Table", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            Help.ShowHelp(this, hlpSample.HelpNamespace);
        }

...
namespace ITSE2353_Lecture7_Shell
{
    public partial class frmTitles : Form
    {
        ...
        private void frmTitles_Load(object sender, EventArgs e)
        {
            ...
            //point to help file
            hlpBooks.HelpNamespace = Application.StartupPath + "\\TitlesPage.chm";
            try
            {
                // connect to books database 
                ProgOps.OpenDatabase();
                ProgOps.TitlesCommand(tbxTitle, tbxYear, tbxISBN, tbxDescription, tbxNotes, tbxSubject, tbxComments, cbxPublisher);
        ...
        {
            this.Text = "Titles - Record " + (titlesManager.Position + 1).ToString() + " of " + 
                titlesManager.Count.ToString() + " Records";
        }

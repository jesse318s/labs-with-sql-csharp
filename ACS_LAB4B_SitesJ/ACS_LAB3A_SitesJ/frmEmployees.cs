...
namespace ACS_LAB3A_SitesJ
{
    public partial class frmEmployees : Form
    {
        ...
        {
            //point to help file
            hlpEmployees.HelpNamespace = Application.StartupPath + "\\Employees.chm";
        ...
        {
            if (myState.Equals("Edit") || myState.Equals("Add New"))
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (myState == "Add New")
                {
                    int newEmployeeID = ProgOps.EmployeesTable.Rows.Count + 1;
                    tbxEmployeeID.Text = newEmployeeID.ToString();
                }
                employeesManager.EndCurrentEdit();
                ProgOps.EmployeesTable.DefaultView.Sort = "EmployeeID";
        ...
        {
            ProgOps.employeeID = tbxEmployeeID.Text;
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            int savedRow = employeesManager.Position;
            DataRow[] foundRows;
            ProgOps.EmployeesTable.DefaultView.Sort = "LastName";
            foundRows = ProgOps.EmployeesTable.Select("LastName LIKE '" + tbxFind.Text + "*'");
            if (foundRows.Length == 0)
            {
                employeesManager.Position = savedRow;
            }
            else
            {
                employeesManager.Position = ProgOps.EmployeesTable.DefaultView.Find(foundRows[0]["LastName"]);
            }
        }
    }
}

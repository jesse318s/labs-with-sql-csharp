...
namespace ACS_Lab2A_SitesJ
{
    class ProgOps
    {
        ...
        public static void DatabaseCommand(string sqlCommand, DataGridView dgvResult)
        {
            //set cmd obj to null
